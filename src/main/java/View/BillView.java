...
public class BillView extends JDialog {
	public BillView(Window parent, String movieName, String genre, String duration, String cinemaName, String showDate,
			String showTime, java.util.List<String> seats, Double tongTienAmount, Double payAmount,
		...
		printBtn.addActionListener(e -> {
			...
			if (userSelection == JFileChooser.APPROVE_OPTION) {
				...
				try (java.io.PrintWriter writer = new java.io.PrintWriter(fileToSave, "UTF-8")) {
					...
					writer.println("===============================");
					JOptionPane.showMessageDialog(this, "Đã lưu hóa đơn thành công!", "Thông báo",
							JOptionPane.INFORMATION_MESSAGE);
				} catch (Exception ex) {
					JOptionPane.showMessageDialog(this, "Lỗi khi lưu hóa đơn: " + ex.getMessage(), "Lỗi",
