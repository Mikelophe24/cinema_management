...
public class QRView extends JDialog {
    public QRView(Window parent, String movieName, String genre, String duration, String cinemaName, String showDate, String showTime, java.util.List<String> seats, int tongTienAmount, int payAmount, String customerName, String customerPhone) {
        ...
        successBtn.addActionListener(e -> {
            dispose();
            new BillView(parent, movieName, genre, duration, cinemaName, showDate, showTime, seats, tongTienAmount, payAmount, "Chuyển khoản", customerName, customerPhone).setVisible(true);
        });
