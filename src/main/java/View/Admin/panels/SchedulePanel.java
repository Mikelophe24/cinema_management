...
public class SchedulePanel extends BasePanel {
	...
	protected void addSampleData() {
		Object[][] sampleData = { { "2024-05-20", "10:00", "Avengers: Endgame", "Phòng 1" },
				{ "2024-05-20", "13:00", "Titanic", "Phòng 2" },
				{ "2024-05-20", "15:30", "The Dark Knight", "Phòng 3" }, { "2024-05-21", "09:00", "Frozen", "Phòng 5" },
				{ "2024-05-21", "11:00", "Inception", "Phòng 4" }, { "2024-05-21", "14:00", "The Matrix", "Phòng 1" } };
	...
	protected void handleAdd() {
		Map<String, String> data = getFormData();
		tableModel.addRow(new Object[] { data.get("Ngày"), data.get("Giờ"), data.get("Phim"), data.get("Phòng") });
		clearForm();
	}
	...
	protected void handleSearch() {
		...
		if (!room.isEmpty()) {
			filter = RowFilter.andFilter(java.util.Arrays.asList(RowFilter.regexFilter("(?i)" + movie, 2),
