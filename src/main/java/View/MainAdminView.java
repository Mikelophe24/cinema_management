...
public class MainAdminView extends JFrame {
    ...
    public MainAdminView(User user) {
    ...
    private void initComponents() {
        ...
        btnRefresh.addActionListener(e -> {
            ...
            Object[] message = {
                "Tên phim:", tfTitle,
                "Thể loại:", tfGenre,
                "Thời lượng (phút):", tfDuration
            };

            int option = JOptionPane.showConfirmDialog(this, message, "Thêm phim", JOptionPane.OK_CANCEL_OPTION);
            if (option == JOptionPane.OK_OPTION) {
                try {
                    Movie newMovie = new Movie(0, tfTitle.getText(), tfGenre.getText(), Integer.parseInt(tfDuration.getText()));
        ...
        btnEdit.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    try {
                        Movie updatedMovie = new Movie(id, tfTitle.getText(), tfGenre.getText(), Integer.parseInt(tfDuration.getText()));
                        MovieDao dao = new MovieDao();
